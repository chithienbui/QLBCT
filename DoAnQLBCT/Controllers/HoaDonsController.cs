...
namespace DoAnQLBCT.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public ActionResult Details(string id)
        {
            ...
            // Lấy danh sách CTHD chỉ với MaHD tương ứng
            var cTHDs = db.CTHDs.Where(cthd => cthd.MaHD == id).ToList();
            ...
            // Truyền danh sách CTHD vào View
            ViewBag.CTHDs = cTHDs;
        ...
        public ActionResult Create([Bind(Include = "MaHD,NgayDat,NgayNhan,DiaChiNhan,TinhTrang,MaNV,MaKH")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,NgayDat,NgayNhan,DiaChiNhan,TinhTrang,MaNV,MaKH")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {
